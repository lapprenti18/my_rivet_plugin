...
function examplePluginNode(rivet) {
  ...
  const examplePluginNode4 = rivet.pluginNodeDefinition(
    ExamplePluginNodeImpl,
    "Example Plugin Node"
  );
  return examplePluginNode4;
}

// src/nodes/ExamplePluginNode2.ts
function examplePluginNode2(rivet) {
  const ExamplePluginNodeImpl2 = {
    // This should create a new instance of your node type from scratch.
    create() {
      const node = {
        // Use rivet.newId to generate new IDs for your nodes.
  ...
  const examplePluginNode22 = rivet.pluginNodeDefinition(
    ExamplePluginNodeImpl2,
    "Example Plugin Node 2"
  );
  return examplePluginNode22;
}

// src/nodes/ExamplePluginNode3.ts
function examplePluginNode3(rivet) {
  const ExamplePluginNodeImpl3 = {
    // This should create a new instance of your node type from scratch.
    create() {
      const node = {
        // Use rivet.newId to generate new IDs for your nodes.
  ...
  const examplePluginNode32 = rivet.pluginNodeDefinition(
    ExamplePluginNodeImpl3,
    "Example Plugin Node 3"
  );
  return examplePluginNode32;
}
